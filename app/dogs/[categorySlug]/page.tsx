...
export default async function DogCategoryPage({ params, searchParams }: CategoryPageProps) {
  const { categorySlug } = await params
  const resolvedSearchParams = await searchParams

  console.log("[DogCategoryPage] Loading category:", categorySlug)
  ...
  try {
    ...
    console.error("[DogCategoryPage] Error fetching data:", err)
    if (!category) {
    ...
    try {
      ...
      console.error("[DogCategoryPage] Failed to fetch brands:", bErr)
      brands = []
    }
  }
