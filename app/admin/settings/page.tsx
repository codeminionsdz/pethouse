                ...
                <div className="p-4 bg-muted rounded-lg">
                  ...
                  <div className="space-y-3 text-sm">
                    <div>
                      ...
                      <p className="text-muted-foreground">PETHOUSE</p>
                    </div>
                    <div>
                      <span className="font-medium">Description:</span>
                      <p className="text-muted-foreground">Premium pet lifestyle store for food, accessories, toys, and expert care for cats, dogs, birds, and more. Quality products delivered across Algeria.</p>
                    </div>
                    <div>
                      <span className="font-medium">Contact Email:</span>
                      <p className="text-muted-foreground">contact@pethouse.dz</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      >
                        https://www.instagram.com/pethouse.bba
                      </a>
                    </div>
                    <div>
                      ...
                      <a
                        ...
                        className="text-primary hover:underline"
                      >
                        https://www.tiktok.com/@pet.house.bba
                      </a>
                    </div>
                  </div>
                </div>
