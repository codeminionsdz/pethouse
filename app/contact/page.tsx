      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a href="mailto:contact@pethouse.dz" className="text-primary font-medium hover:underline">
                  contact@pethouse.dz
                </a>
              </div>
            </div>
        ...
        <div className="mb-12">
          ...
          <div className="rounded-lg overflow-hidden border border-border shadow-lg">
            <iframe
              src="https://maps.google.com/?cid=15732382943059604595&g_mp=CiVnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLkdldFBsYWNlEAEYASAB&hl=en&gl=DZ&source=embed"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
