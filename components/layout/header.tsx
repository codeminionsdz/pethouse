...
export function Header({ categories: initialCategories }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-secondary/90 text-foreground border-b border-border/60 shadow-sm">
      ...
      <div className="container mx-auto px-4 py-5">
        <div className="flex items-center justify-between gap-4">
          ...
          <Link href="/" className="flex items-center gap-3 shrink-0">
            <div className="relative w-12 h-12 md:w-14 md:h-14 bg-card rounded-2xl p-1 shadow-sm border border-border">
              <Image
                src="/logo.png"
                alt="PETHOUSE"
                width={48}
            ...
            <span className="text-xl md:text-2xl font-bold text-primary hidden sm:block tracking-[0.14em] uppercase">
              PETHOUSE
            </span>
          </Link>
          ...
          <div className="hidden md:flex flex-1 max-w-xl">
            <form action="/search" method="get" className="relative w-full">
              ...
              <Input
                ...
                className="w-full pl-10 pr-4 h-11 bg-card border border-border focus-visible:ring-primary"
              />
            </form>
          </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-2">
                      {ANIMALS.map((animal) => (
                        <Link
                          ...
                          className="px-3 py-2 rounded-xl text-sm font-medium bg-secondary border border-border hover:bg-secondary/80 text-center"
                        >
                          {animal.label}
                        </Link>
                      ))}
