          ...
          {heroSlides.map((slide, index) => {
            ...
            return (
              <div key={slide.id} className="flex-[0_0_100%] min-w-0 shrink-0">
                <section 
                  className="relative overflow-hidden min-h-[500px] md:min-h-[600px] bg-gradient-to-br from-background via-background to-primary/10"
                  style={{
                ...
                >
                  ...
                  <div 
                    ...
                    style={{
                      background: `linear-gradient(135deg, rgba(26,39,64,0.28) 0%, rgba(26,39,64,0.2) 50%, rgba(127,168,255,0.22) 100%)`,
                    }}
                  />
                  ...
                  <svg className="hero-paw-pattern animate-float-gentle" style={{ top: '10%', right: '8%', width: '80px', height: '80px' }} viewBox="0 0 100 100">
                    <circle cx="50" cy="30" r="12" fill="#A9C2FF" />
                    <circle cx="20" cy="60" r="10" fill="#A9C2FF" />
                    <circle cx="50" cy="70" r="10" fill="#A9C2FF" />
                    <circle cx="80" cy="60" r="10" fill="#A9C2FF" />
                  </svg>
                  ...
                  <svg className="hero-paw-pattern animate-float-gentle animation-delay-800" style={{ bottom: '15%', right: '15%', width: '60px', height: '60px' }} viewBox="0 0 100 100">
                    <circle cx="50" cy="30" r="12" fill="#7FA8FF" />
                    <circle cx="20" cy="60" r="10" fill="#7FA8FF" />
                    <circle cx="50" cy="70" r="10" fill="#7FA8FF" />
                    <circle cx="80" cy="60" r="10" fill="#7FA8FF" />
                  </svg>

                  <div className="container relative mx-auto px-4 py-16 md:py-24 lg:py-32 z-10">
                  <div className="max-w-3xl mx-auto text-center">
                    {/* Animated badge */}
                    <div className="inline-flex items-center gap-2 px-5 py-2 bg-primary/90 backdrop-blur-sm border border-primary/30 text-white text-sm font-semibold rounded-full mb-6 shadow-lg animate-fade-in-up hover:bg-primary transition-colors">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up animation-delay-600">
                      <Button size="lg" className="group btn-hover-lift shadow-xl bg-primary hover:bg-primary/90 text-white font-semibold" asChild>
                        <Link href={slide.primaryBtnHref}>
                          {t(slide.primaryBtnKey as any)}
                          <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                        </Link>
                      </Button>
                      <Button size="lg" variant="outline" className="btn-hover-lift bg-card/90 text-foreground shadow-xl hover:bg-card font-semibold border-2 border-border" asChild>
          ...
          <button
            ...
            className={cn(
              ...
              index === selectedIndex
                ...
                : "w-3 bg-background/60 hover:bg-background/85"
            )}
