    ...
    >
      ...
      <Link href={`/products/${product.slug}`} className="block relative aspect-square overflow-hidden bg-secondary">
        ...
        <Button
          variant="secondary"
          size="icon"
          className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-200 bg-card shadow-md hover:bg-primary hover:text-primary-foreground rounded-full hover:scale-110"
          onClick={(e) => {
            e.preventDefault()
            e.stopPropagation()
      ...
      <div className="p-6 space-y-3">
        ...
        <div className="bg-secondary rounded-lg p-4 border-2 border-border">
        ...
        <Button 
          className="w-full mt-4 btn-pet bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-base h-12 rounded-pill shadow-pet-md hover:shadow-pet-lg transition-all duration-300 hover:-translate-y-1 group/btn"
