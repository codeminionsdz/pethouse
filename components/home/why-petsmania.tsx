      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          <p className="text-muted-foreground text-sm">
            ✨ {language === "ar" ? "اختر PETHOUSE لسعادة حيوانك الأليف" : language === "fr" ? "Choisissez PETHOUSE pour le bien-être de votre animal" : "Choose PETHOUSE for your pet's happiness"} ✨
          </p>
        </div>
      </div>
    </section>
