...
const HeroCarousel = dynamic(() => import("@/components/layout/hero-carousel").then((mod) => mod.HeroCarousel), {
  ssr: false,
})

const AnimalCategoriesSection = dynamic(
  () => import("@/components/home/animal-categories-section").then((mod) => mod.AnimalCategoriesSection),
  { ssr: false },
)
